...
cmake .. \
	-DCMAKE_OSX_DEPLOYMENT_TARGET=$osver -DCMAKE_FIND_FRAMEWORK=LAST -DCMAKE_OSX_ARCHITECTURES=${arch} \
	-DCMAKE_INSTALL_PREFIX=${THIS_DIR}/macos/ -DCMAKE_BUILD_TYPE=${build_type} \
